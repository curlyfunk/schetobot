...
const Footer = () => {
  ...
  const footerLinks = {
    product: [
      ...
      { name: 'AI Асистент', href: '/ai-assistant' },
    ],
    company: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-white">e-doc.bg</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Платформа за генериране на електронни документи, декларации и формуляри за български институции (НАП, НОИ, Общини).
            </p>
          ...
          {/* Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Продукти</h3>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            &copy; {currentYear} e-doc.bg. Всички права запазени.
          </p>
          <div className="mt-4 md:mt-0 flex items-center">
            <span className="text-gray-300 text-sm mr-2">Разработено с</span>
            <svg className="h-4 w-4 text-red-500" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
            </svg>
            <span className="text-gray-300 text-sm ml-2">в България</span>
          </div>
        </div>
      </div>
    </footer>
